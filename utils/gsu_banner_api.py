...
def get_gsu_sections(course_code: str, term: Optional[str] = None) -> List[Dict]:
    """
    Main function: Get real GSU sections for a course
    ...
    # A substring match would wrongly include e.g. CSC 3320 when asked for CSC 320.
...
if __name__ == "__main__":
    print("=" * 70)
    print("GSU Banner API - Live Course Data")
    print("=" * 70)
    ...
    if sections:
        print(f"\n✅ Found {len(sections)} sections for CSC 3320:\n")
        ...
        # Save to file
        output_file = "data/gsu_sections_real.json"
        import os
        ...
        print("3. Need to be logged in to GSU")
